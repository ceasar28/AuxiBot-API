...
class EventController {
    createEvent(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const cronExpressionOneHourBefore = `${utcTime.getUTCMinutes()} ${adjustedHours - 1} ${utcTime.getUTCDate()} ${utcTime.getUTCMonth() + 1} *`;
            // Subtract 2 minutes from the current UTC time
            utcTime.setUTCMinutes(utcTime.getUTCMinutes() - 2);
            const cronExpressionTwoMinutesBefore = `${utcTime.getUTCMinutes()} ${utcTime.getUTCHours()} ${utcTime.getUTCDate()} ${utcTime.getUTCMonth() + 1} *`;
